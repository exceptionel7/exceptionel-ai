/*
 * webhook.js — Vérification de la signature des webhooks Stripe (crypto natif).
 *
 * Stripe signe chaque webhook avec l'en-tête :
 *   Stripe-Signature: t=<timestamp>,v1=<signature>[,v1=<autre>]
 * La signature = HMAC-SHA256( "<t>.<rawBody>" , webhook_secret ).
 *
 * On DOIT utiliser le CORPS BRUT (non parsé) pour que la vérification marche.
 */
...
/**
 * Vérifie la signature. @returns {boolean}
 * toleranceSec : rejette les événements trop anciens (protection anti-rejeu).
 */
